            ...
            <div className=' card-body  text-black'>
                ...
                <div className='grid grid-cols-2'>
                    <div className="flex justify-start items-center text-sm text-gray-600">
                        ...
                        <span className="font-semibold text-black text-xl">4.9 <span className='text-blue-700 text-lg'>★</span></span>
                    </div>


                    <div className="card-actions mt-2 w-full">
                        {/* <Link to={`/product-details/${_id}`} className="btn btn-primary px-8">View Details</Link> */}
                        <button className='btn btn-primary bg-black rounded-4xl w-full' >View Details</button>
                    </div>
                </div>
            </div>
        </div>
